...
Do not add MQTT-, CoAP-, LwM2M-, or other transport-specific columns to the main device list. Use generic columns such as `Communication`, `Status`, or `Access`, and represent configured protocols as compact protocol labels or pills.
